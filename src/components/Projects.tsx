...
function Projects() {
  ...
  return (
    <section
      id="projects"
      className="relative min-h-screen bg-gradient-to-b from-black via-gray-900 to-black
dark:from-white dark:via-gray-50 dark:to-white py-20"
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => {
            return (
              <div
                key={project.id}
                className="group relative bg-white/5 dark:bg-black/5 backdrop-blur-sm border border-white/10 dark:border-black/10 rounded-2xl overflow-hidden hover:bg-white/10 dark:hover:bg-black/10 transition-all duration-300"
              >
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <a
                      ...
                      className="p-3 bg-white/10 dark:bg-black/10 backdrop-blur-md rounded-full hover:bg-white/20 dark:hover:bg-black/20 transition-all duration-300"
                    >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, index) => {
                      return (
                        <span
                          key={index}
                          className="px-3 py-1 text-xs bg-purple-600/20 dark:bg-purple-100 text-purple-300 dark:text-purple-700 rounded-full border border-purple-600/30 dark:border-purple-300"
                        >
                          {tech}
                        </span>
                      );
        ...
        {projects.length === 0 && (
          <div className="text-center py-20">
            <p className="text-gray-400 dark:text-gray-600 text-xl">
